...
import (
	...
	"github.com/efiacor/porch-gcp-controllers/controllers/fleetsyncs/api/v1alpha1"
	"github.com/efiacor/porch-gcp-controllers/controllers/fleetsyncs/pkg/controllers/fleetsync/fleetpoller"
	"github.com/efiacor/porch-gcp-controllers/controllers/utils"
...
//go:generate go run sigs.k8s.io/controller-tools/cmd/controller-gen@v0.14.0 rbac:headerFile=../../../../../scripts/boilerplate.yaml.txt,roleName=porch-controllers-fleetsyncs webhook paths="." output:rbac:artifacts:config=../../../config/rbac
...
func membershipId(hubMembership *gkehubv1.Membership) (string, error) {
	...
	return utils.KubernetesName(segments[1]+"-"+segments[3]+"-"+segments[5], nameHashLen, nameMaxLen), nil
}
...
func bindingId(binding *gkehubv1.MembershipBinding) (string, error) {
	...
	return utils.KubernetesName(segments[1]+"-"+segments[3]+"-"+segments[5]+"-"+segments[7], nameHashLen, nameMaxLen), nil
}
